...
namespace DiBK.Gml2Sosi.Reguleringsplanforslag.Mappers
{
    public class RpInfrastrukturSoneMapper : ISosiElementMapper<RpInfrastrukturSone>
    {
        ...
        public RpInfrastrukturSone Map(XElement featureElement, GmlDocument document)
        {
            var rpInfrastrukturSone = _rpHensynSoneMapper.Map<RpInfrastrukturSone>(featureElement, document);
